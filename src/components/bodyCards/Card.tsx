...
const ProductCard: React.FC<Props> = ({ product }) => {
 ...
 hover:scale-105 hover:shadow-2xl  group-hover:brightness-110 transition duration-300 border border-gray-300 rounded-lg shadow-sm w-80 mx-auto "
        >
            <div className="relative">
                ...
                /> */}
                <span
                    className={`absolute top-3 right-3 px-3 py-1 text-xs rounded-full font-semibold shadow ${status === "available"
